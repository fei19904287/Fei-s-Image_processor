...
/**
 * a visualizeblue class to visualize the image.
 */
public class VisualizeBlueCommand implements ICommand {

  /**
   * to execute the visualize blue command.
   *
  ...
  public void run(Scanner scanner, ImageDatabase model) throws FileNotFoundException {
    ...
    model.add(afterGreyScaleId, blueImage);
  }
}
